 export const goodsList = [
  ...
  {
    id: 2,
    goodsClassName: '服装鞋帽', // 商品大类
    children: [
      {
        id: '2-1', // id
        title: '商品名称1', // 商品名称
        price: '150', // 价格
        crossedRice: '160', // 划线价格
        discountNum: 7.2, // 折扣
        salesVolume: 100, // 销量
        imitNum: 1, // 限购
        specificationShow: false, // 规格显示
  ...
  {
    id: 3,
    goodsClassName: '家居用品', // 商品大类
    children: [
      {
        id: '3-1', // id
        title: '商品名称1', // 商品名称
        price: '180', // 价格
        crossedRice: '190', // 划线价格
        discountNum: 7.8, // 折扣
        salesVolume: 110, // 销量
        imitNum: 1, // 限购
        specificationShow: false, // 规格显示
